  ...
  return (
    <div className="flex min-h-screen bg-[#fdfbf0]">
        ...
        <nav className="flex-1 space-y-2">
          {sidebarItems.map((item, index) => {
            const routeMap: Record<string, string> = {
              ...
              "Assignment Management": "/partner_dashboard/assignement_management",
      ...
      <main className="flex-1 p-8 bg-[#fdfbf0]">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-800">Assigned Schools</h1>
          <p className="text-gray-600 mt-2">View and manage your assigned schools</p>
        </div>

        <div className="bg-white rounded-2xl p-6 shadow-sm border-2 border-[#e8e4d8]">
          <p className="text-gray-700">Assigned schools content will be displayed here.</p>
        </div>
      </main>
    </div>
  );
